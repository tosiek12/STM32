...
#define LIS3DSH_SPI_CLK()					__SPI1_CLK_ENABLE()

#define LIS3DSH_SPI_SCK_PIN					GPIO_PIN_5					// PA.05
#define LIS3DSH_SPI_SCK_GPIO_PORT			GPIOA						// GPIOA
#define LIS3DSH_SPI_SCK_GPIO_CLK()			__GPIOA_CLK_ENABLE()
...
#define LIS3DSH_SPI_MISO_GPIO_CLK()			__GPIOA_CLK_ENABLE()
...
#define LIS3DSH_SPI_MOSI_GPIO_CLK()			__GPIOA_CLK_ENABLE()
...
#define LIS3DSH_SPI_CS_GPIO_CLK()			__GPIOE_CLK_ENABLE()

#define LIS3DSH_SPI_INT1_PIN				GPIO_PIN_0					// PE.00
#define LIS3DSH_SPI_INT1_GPIO_PORT			GPIOE						// GPIOE
#define LIS3DSH_SPI_INT1_GPIO_CLK()			__GPIOE_CLK_ENABLE()
...
#define LIS3DSH_SPI_INT2_GPIO_CLK()			__GPIOE_CLK_ENABLE()
...
#define _LIS3DSH_BW_MASK					((uint8_t)0b11000000)
#define _LIS3DSH_BW_800HZ			        0x00   // Filter (800Hz)
#define _LIS3DSH_BW_400HZ					0x40   // Filter (400Hz)
#define _LIS3DSH_BW_200HZ					0x80   // Filter (200Hz)
#define _LIS3DSH_BW_50HZ					0xC0   // Filter (50Hz)

#define _LIS3DSH_FSCALE_MASK				((uint8_t)0b00111000)
#define _LIS3DSH_FSCALE_2G					((uint8_t)0b00000000)
#define _LIS3DSH_FSCALE_4G					((uint8_t)0b00001000)
#define _LIS3DSH_FSCALE_6G					((uint8_t)0b00010000)
#define _LIS3DSH_FSCALE_8G					((uint8_t)0b00011000)
#define _LIS3DSH_FSCALE_16G					((uint8_t)0b00100000)
#define  LIS3DSH_2G_FACTOR    ((float)0.06)     // 15mg per Digit (+/-2g)
#define  LIS3DSH_4G_FACTOR    ((float)0.12)     // 31mg per Digit (+/-4g)
#define  LIS3DSH_6G_FACTOR    ((float)0.18)     // 46mg per Digit (+/-6g)
#define  LIS3DSH_8G_FACTOR    ((float)0.24)     // 61mg per Digit (+/-8g)
#define  LIS3DSH_16G_FACTOR   ((float)0.73)    // 187mg per Digit (+/-16g)
	/* Sensitivity from datasheet [mg/LSB]:
	 * FS	|value for 16bit|value for 8bit
	 * 000	|0.06			|15				(default range 2g)
	 * 001	|0.12			|31
	 * 010	|0.18			|46
	 * 011	|0.24			|61
	 * 100	|0.73			|187
